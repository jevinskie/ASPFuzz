...
impl ExceptionHandler {
    ...
    pub fn stop(&self, qemu: &Qemu) {
        ...
        let _ = qemu
            .hooks()
            .remove_instruction_hooks_at(self.exception_addr_undef, true);
        let _ = qemu
            .hooks()
            .remove_instruction_hooks_at(self.exception_addr_svc, true);
        let _ = qemu
            .hooks()
            .remove_instruction_hooks_at(self.exception_addr_preab, true);
        let _ = qemu
            .hooks()
            .remove_instruction_hooks_at(self.exception_addr_datab, true);
        let _ = qemu
            .hooks()
            .remove_instruction_hooks_at(self.exception_addr_hyp, true);
        let _ = qemu
            .hooks()
            .remove_instruction_hooks_at(self.exception_addr_irq, true);
        let _ = qemu
            .hooks()
            .remove_instruction_hooks_at(self.exception_addr_fiq, true);
    }
}
